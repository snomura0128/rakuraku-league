...
const createLeagueSchema = z.object({
  ...
  participants: z
    .array(z.string().min(1, "選手名は必須です").max(50, "選手名は50文字以内で入力してください"))
    .min(3, "最低3名の選手が必要です")
...
export default function CreateLeaguePage() {
  ...
  const getWizardSteps = () => {
    return WIZARD_STEPS.map((step, index) => ({
      ...step,
      status: (index < currentStep ? "completed" : index === currentStep ? "active" : "pending") as
        | "completed"
        | "active"
        | "pending",
    }))
        ...
        <header className="bg-white shadow-sm border-b border-border-light">
          <div className="container py-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-primary">リーグ戦を作成</h1>
                    ...
                    <div className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          ...
                          {errors.table_count && (
                            <p className="text-sm text-red-600">{errors.table_count.message}</p>
                          )}
                        </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <Select
                            onValueChange={(value) =>
                              setValue("match_format", value as "1_game" | "3_game" | "5_game")
                            }
                            defaultValue="5_game"
                          >
                            ...
                            <SelectContent>
                              <SelectItem value="1_game">{formatMatchFormat("1_game")}</SelectItem>
                              <SelectItem value="3_game">{formatMatchFormat("3_game")}</SelectItem>
                              <SelectItem value="5_game">{formatMatchFormat("5_game")}</SelectItem>
                            </SelectContent>
                          </Select>
                          {errors.match_format && (
                            <p className="text-sm text-red-600">{errors.match_format.message}</p>
                          )}
                        </div>
                      </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <p className="font-medium text-text-primary">
                              {formatMatchFormat(watchedValues.match_format || "5_game")}
                            </p>
                  ...
                  >
                    <div className="space-y-4">
                      ...
                      <div className="text-sm text-text-tertiary">
                        現在 {participants.filter((p) => p.trim()).length}名 / 最大15名
                      </div>
                    </div>
                  </WizardStep>
                  ...
                  >
                    <div className="bg-gray-50 rounded-lg p-6 space-y-6">
                      ...
                      <div className="py-3 border-b border-gray-200">
                        <div className="text-sm font-medium text-gray-600 mb-3">選手一覧</div>
